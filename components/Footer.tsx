import { Box, Plane, Send } from "lucide-react";
import Link from "next/link";

const Footer = () => {
  return (
    <footer className="mx-auto max-w-7xl py-10 mt-12">
      <div className="bg-gray-900 rounded-2xl p-8 flex flex-col md:flex-row md:p-12 items-center justify-between relative overflow-hidden">
        <div className="flex flex-col gap-4 w-full md:w-2/5 md:text-left">
        ...
        <div className="mt-8 md:mt-0 flex flex-col gap-2 items-center w-full md:w-auto">
          ...
          >
            <input
              ...
              className="p-3 bg-gray-700/50 text-xs md:text-sm text-white rounded-xl border border-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400 placeholder-gray-400 w-full md:w-3/5"
            />
            <button className="flex flex-row justify-center items-center gap-2 text-xs bg-white hover:bg-gray-100 text-gray-900 font-semibold py-3 px-4 rounded-xl transition duration-300 ease-in-out">
              Let's Talk{" "}
              <span>
